						...
						<TABLE cellSpacing=0 cellPadding=5  border=0>
							...
							<TR>
								...
								<td>
									...
									<%--<INPUT class=textbox id=sChannel1
										   style="WIDTH: 180px" maxLength=50 name="baseDictLevel.dict_item_name">--%>
								</td>
							</TR>
							...
							<TR>
								...
								<td>
									...
									<%--<INPUT class=textbox id=sChannel1
										   style="WIDTH: 180px" maxLength=50 name="baseDictSource.dict_item_name">--%>
								</td>
								<td>所属行业 ：</td>
								<td>
									...
									<%--<INPUT class=textbox id=sChannel1
										   style="WIDTH: 180px" maxLength=50 name="baseDictIndustry.dict_item_name">--%>
